//! R pondéré — la couche comptable des ventes partielles (unipanel).
//!
//!
...
/// - TP2+BE → f1·tp1 + f2·tp2 + f3·r_solde (CORRECTIF 15/09 nuit : le stop
///   suiveur post-TP2 est à TP1 — lifecycle `tp2_sl_hit` — le solde s'y
///   encaisse ; `r_solde_tp2` porte le R vécu, repli TP1 si None) ;
