...
/// Permet le rapatriement GPU→CPU des poids après entraînement tch-rs.
#[cfg(feature = "cuda")]
...
/// Longueur de séquence : 60 timesteps (dernières 60 fenêtres de features — fenêtre ML complète)
pub const LONGUEUR_SEQ: usize = 60;
