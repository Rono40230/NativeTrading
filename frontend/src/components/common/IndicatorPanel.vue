...
const smcOptions = [
  ...
  { key: 'smcLiquidites', label: 'BSL/SSL',      activeClass: 'bg-rose-500/20 border-rose-500/40 text-rose-300',           gearClass: 'bg-rose-500/10 border-rose-500/40 text-rose-400 hover:bg-rose-500/20'           },
]
</script>
