...
| 5.2 | Backfill Dukascopy | Historique profond au service du **backtest** (le replay du runtime utilise la DB existante). **À trancher ici** (décision propriétaire 2026-08-15) : sync incrémentale automatique quotidienne (jours manquants seulement, ~secondes/jour) pour les assets Dukascopy actifs — le bouton ⬇ resterait pour l'initialisation profonde et les trous anciens |
...
| 1 | Cœur fiable | Tests verts + 24 h bougies 100 % + résilience | ⬜ |
